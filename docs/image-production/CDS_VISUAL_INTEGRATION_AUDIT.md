...
| `CDS-006` | Home Callizto portrait | Corrected | Corrected | Corrected stacked panel | `.portrait-callizto img`; `object-fit:cover`, `center top` | Complete face, bangs, hair, upper-body identity | None beyond human review | corrected-awaiting-human-review |
| `CDS-007` | Home Seraphina portrait | Acceptable | Acceptable | Acceptable stacked panel | `.portrait-seraphina img`; `object-fit:cover`, `center center` | Face, hair, pink highlights remain readable | Kept independent so Callizto and Scarlett corrections do not move it | acceptable-awaiting-human-review |
| `CDS-008` | Home Scarlett portrait | Corrected | Corrected | Corrected stacked panel | `.portrait-scarlett img`; `object-fit:cover`, `center top` | Complete face and red hair restored | None beyond human review | corrected-awaiting-human-review |
...
| `CDS-011` | Band Callizto profile | Corrected | Corrected | Corrected responsive profile | `.member-callizto .member-image img`; `object-fit:cover`, `center 38%` | Complete face, bangs, purple hair identity | None beyond human review | corrected-awaiting-human-review |
| `CDS-012` | Band Seraphina profile | Corrected | Corrected | Corrected responsive profile | `.member-seraphina .member-image img`; `object-fit:cover`, `center top` | Complete face, bangs, blonde/pink hair | None beyond human review | corrected-awaiting-human-review |
| `CDS-013` | Band Scarlett profile | Corrected | Corrected | Corrected responsive profile | `.member-scarlett .member-image`; header inset. Image `center top`, height reduced by header | Complete face and red hair remain below fixed navigation | Intentional black inset protects hair from header | corrected-awaiting-human-review |
